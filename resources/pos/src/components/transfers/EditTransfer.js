...
import { fetchTransfer, postTransfer } from '../../store/action/transfersAction';
...
export default connect( mapStateToProps, { fetchAllWarehouses, fetchTransfer, postTransfer } )( EditTransfer );
