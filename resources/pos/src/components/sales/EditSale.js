...
import { editSale, fetchSale, postSale } from '../../store/action/salesAction';
...
export default connect( mapStateToProps, { fetchSale, editSale, fetchAllCustomer, fetchAllWarehouses, fetchPaymentMethods, postSale} )( EditSale );
