...
import {fetchExpense, postExpense} from '../../store/action/expenseAction';
...
export default connect(mapStateToProps, {fetchExpense, fetchWarehouses, fetchExpenseCategories, postExpense})(EditExpense);
