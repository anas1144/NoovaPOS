        ...
        <MasterLayout>
            ...
            <div className='card'>
                <div className='m-auto mb-5 col-12 mt-5 text-center'>
                    <h3>{stockWarehouse && stockWarehouse.length > 0 && stockWarehouse[0].product && stockWarehouse[0].product.name}</h3>
                </div>
                <div className='col-md-5 ms-5'>
                    <table className='table table-responsive'>
                        ...
                        {stockWarehouse && stockWarehouse.length > 0 && stockWarehouse.map((warehouse, index) => {
                            return (
                                <tr key={index}>
                                    <td>{warehouse && warehouse.warehouse && warehouse.warehouse.name}</td>
                                    <td>{warehouse && warehouse.quantity ? (warehouse.quantity).toFixed(2) : 0} {stockWarehouse && stockWarehouse.length > 0 && stockWarehouse[0] && stockWarehouse[0].product && stockWarehouse[0].product.product_unit === "1" && "Pc" || stockWarehouse && stockWarehouse.length > 0 && stockWarehouse[0] && stockWarehouse[0].product && stockWarehouse[0].product.product_unit === "2" && "M" || stockWarehouse && stockWarehouse.length > 0 && stockWarehouse[0] && stockWarehouse[0].product && stockWarehouse[0].product.product_unit === "3" && "Kg"}</td>
                                </tr>
                            )
                        })}
