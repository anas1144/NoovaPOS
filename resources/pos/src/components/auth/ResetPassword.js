...
const ResetPassword = (props) => {
    const {resetPassword, fetchFrontCms, frontCms} = props
    ...
    return (
        <div className='d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20 vh-100'>
            ...
            <div className='mb-12 col-12 text-center'>
                <Image className='logo-height' src={frontCms && frontCms.value && frontCms.value.logo}/>
            </div>
...
const mapStateToProps = (state) => {
    const {frontCms} = state;
    return {frontCms}
};

export default connect(mapStateToProps, {resetPassword, fetchFrontCms})(ResetPassword);
