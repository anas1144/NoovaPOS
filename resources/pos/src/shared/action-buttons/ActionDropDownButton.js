...
const ActionDropDownButton = (props) => {
    const {
        ...
        isCreatePurchaseReturn, onCreatePurchaseReturnClick, isReceiptIcon, onReceiptClick, isDeleteMode, onClickPost = null, isPostMode = false, isPosting = false
    } = props;
            ...
            <Dropdown.Menu>
                ...
                {isPostMode && onClickPost && 
                    <Dropdown.Item onClick={(e) => {
                        ...
                        <FontAwesomeIcon icon={faFileImport} className='me-2 text-success'/>
                        {isPosting ? getFormattedMessage('globally.post.posting') : getFormattedMessage('globally.post.button')}
                    </Dropdown.Item>
                }
