...
export const apiBaseURL = {
    ...
    ROLES: "/roles",
    ROLE_AVAILABLE_TEMPLATES: "/roles/available-templates",
    ROLE_FROM_TEMPLATE: "/roles/from-template",
    BILLING_OVERVIEW: "/billing/overview",
    BILLING_REQUEST: "/billing/request",
    BILLING_ADDON_REQUEST: "/billing/addon-request",
    BILLING_FBR_REQUEST: "/billing/fbr-request",
    PUBLIC_COUNTRIES: "public/countries",
    PUBLIC_CURRENCIES: "public/currencies",
    PUBLIC_SHOP_TYPES: "public/shop-types",
    PLATFORM_SHOP_TYPES: "platform/shop-types",
    PLATFORM_FEATURES: "platform/features",
    PLATFORM_CMS_PAGES: "platform/cms/pages",
    PLATFORM_BLOG: "platform/blog",
    PUBLIC_COUNTRIES_LIST: "public/countries",
    STORE_FEATURES: "store-features",
    MY_FEATURES: "my-features",
    ATTENDANCE_STATUS: "attendance/status",
    ATTENDANCE_IDENTIFY: "attendance/identify",
    ...
    ATTENDANCE_TASKS: "attendance/tasks",
    ATTENDANCE_TASK_START: "attendance/tasks/start",
    ATTENDANCE_DASHBOARD: "attendance/dashboard",
    ATTENDANCE_LIVE: "attendance/live",
    ATTENDANCE_RECORDS: "attendance/records",
    ATTENDANCE_SETTINGS: "attendance/settings",
    ATTENDANCE_BIOMETRICS: "attendance/biometrics",
    ATTENDANCE_FACE_DATA: "attendance/biometrics/face-data",
    ATTENDANCE_FACE_ENROLL: "attendance/biometrics/face",
    ATTENDANCE_FINGERPRINT_ENROLL: "attendance/biometrics/fingerprint",
    ATTENDANCE_DEVICE_CONNECTORS: "attendance/device-connectors",
    HR_EMPLOYEES: "hr/employees",
    PRODUCT_BATCHES: "product-batches",
    PRODUCT_BATCHES_NEAR_EXPIRY: "product-batches/near-expiry",
    PRODUCTS_LIST: "products",
    WATER_ROUTES: "water/routes",
    WATER_BOTTLES: "water/bottles",
    WATER_BOTTLE_BALANCES: "water/bottle-balances",
    WATER_DEPOSITS: "water/deposits",
    CUSTOMERS_LIST: "customers",
    BAKERY_RECIPES: "bakery/recipes",
    BAKERY_PRODUCTION: "bakery/production",
    ELECTRONICS_SERIALS: "electronics/serials",
    ELECTRONICS_WARRANTIES: "electronics/warranties",
    ELECTRONICS_WARRANTY_LOOKUP: "electronics/warranty-lookup",
    DISTRIBUTION_ROUTES: "distribution/routes",
    DISTRIBUTION_LOADS: "distribution/loads",
    RECURRING_OVERDUE: "recurring/overdue",
    RECURRING_INVOICES: "recurring/invoices",
    FBR_DI_BUSINESSES: "fbr-di/businesses",
    FBR_DI_PRODUCTS: "fbr-di/products",
    FBR_DI_HS_CODES: "fbr-di/hs-codes",
    FBR_DI_INVOICES: "fbr-di/invoices",
    FBR_DI_ERRORS: "fbr-di/errors",
    FBR_DI_SANDBOX: "fbr-di/sandbox",
    FBR_DI_DASHBOARD: "fbr-di/dashboard",
    FBR_DI_REPORT_SALES: "fbr-di/reports/sales",
    FBR_DI_REPORT_TAX: "fbr-di/reports/tax",
    FBR_DI_REPORT_SYNC: "fbr-di/reports/sync",
    FBR_DI_REPORT_REJECTED: "fbr-di/reports/rejected",
    PLATFORM_FBR_DI_LIMITS: "platform/fbr-di/limits",
    PLATFORM_FBR_DI_AGENTS: "platform/fbr-di/agents",
    ATTENDANCE_REQUESTS: "attendance/requests",
    ATTENDANCE_REPORT_SUMMARY: "attendance/reports/summary",
    ATTENDANCE_REPORT_PRODUCTIVITY: "attendance/reports/productivity",
    ATTENDANCE_REPORT_PERFORMANCE: "attendance/reports/performance",
    ATTENDANCE_WEBAUTHN_REGISTER_OPTIONS: "attendance/webauthn/register-options",
    ATTENDANCE_WEBAUTHN_REGISTER: "attendance/webauthn/register",
    ATTENDANCE_WEBAUTHN_LOGIN_OPTIONS: "attendance/webauthn/login-options",
    ATTENDANCE_WEBAUTHN_VERIFY: "attendance/webauthn/verify",
    PRICE_TIERS: "price-tiers",
    DEALS: "deals",
    PRODUCT_UNIT_LEVELS: "products/{id}/unit-levels",
    DELIVERY_BOYS: "delivery-boys",
    CUSTOMER_DISPLAYS: "customer-displays",
    CUSTOMER_ORDERS: "customer-orders",
    RESTAURANT_KITCHENS_LIST: "restaurant/kitchens",
    PLATFORM_PAYMENTS: "platform/payments",
    PLATFORM_BANK_ACCOUNTS: "platform/bank-accounts",
    PLATFORM_SETTINGS: "platform/settings",
    PLATFORM_BILLING_METHODS: "platform/billing-methods",
    ...
    PLATFORM_ROLE_TEMPLATES: "platform/role-templates",
    PLATFORM_PERMISSION_CATALOG: "platform/role-templates/permission-catalog",
...
export const platformActionType = {
    ...
    FETCH_ROLE_TEMPLATES: "FETCH_ROLE_TEMPLATES",
    FETCH_PERMISSION_CATALOG: "FETCH_PERMISSION_CATALOG",
    FETCH_PLATFORM_PAYMENTS: "FETCH_PLATFORM_PAYMENTS",
