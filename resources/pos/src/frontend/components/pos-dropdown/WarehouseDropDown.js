...
const WarehouseDropDown = (props) => {
    ...
    return (
        <div className='select-box col-6 ps-sm-2 px-2 position-relative'>
            <InputGroup>
                <InputGroup.Text id='basic-addon1' className='bg-transparent position-absolute border-0 z-index-1 input-group-text py-2 px-3'>
