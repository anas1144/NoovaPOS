...
class SaleReturnAPIController extends AppBaseController
{
    ...
    /**
     * Post a sale return - Apply stock changes and mark as posted
     */
    public function post(int $id): SaleReturnResource
    {
        $saleReturn = $this->saleReturnRepository->postSaleReturn($id);
